...
<template>
  <div class="h-full w-full flex items-start justify-start bg=[#1d232a] relative">
    <h1 class="text-7xl p-20 pb-10 font-bold text-left text-zinc-100">
      {{ title }}
    </h1>
    <p class="text-4xl p pl-20 font-bold text-left text-zinc-100">
      {{ subtitle }}
    </p>

    <svg
      class="absolute bottom-0 left-0 right-0 fill-primary-content"
